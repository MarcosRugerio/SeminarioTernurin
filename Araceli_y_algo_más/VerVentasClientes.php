...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
    ...
    <a href="VerVentas.php">
      <img class="d-block mx-auto mb-4" src="img/Vventas.png" alt="" width="110" height="110">
              </a>
<!--Graficas-->
<div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-primary">
                    <div class="panel panel-heading">
                        <center> <h2 class="titulo">Gráficas de las Ventas Generadas por los Pedidos de Clientes en el Mes</h2></center>
                    </div>
          ...
          <ul class=" mx-auto mb-2 mb-lg-0">
            ...
            <div>
              <form ction="buscar.php" method="POST" class="d-flex" role="search">
                ...
                <input class="form-control me-2" name="buscar" id="" type="search" placeholder="Ingrese el código" aria-label="Search">
            ...
            <table class="table table-bordered border border-secondary">
              <center>
                ...
                <table class="tablaventas">
                  ...
                  <tr class="tablaventas2">
                    <th class="tablaventas2">
                      <center>Código</center>
                    </th>
                    <th class="tablaventas2">
                      <center>Nombre de la Bebebida o Alimento</center>
                    </th>
                    <th class="tablaventas2">
                      <center>Cantidad Vendida</center>
                    </th>
                  </tr>

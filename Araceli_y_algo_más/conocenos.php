    ...
    <section class="content-section  text-dark text-center" style="background:  #F9ECDC;" id="services">
        <div class="container px-4 px-lg-5">
            <div class="content-section-heading">
                <br>
                <h2 class="display-4" style="color: linear-gradient(90deg, rgb(20%, 40%, 60%), rgb(60%, 20%, 40%));">Valores</h2>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <h2 class="display-6">Honestidad</h2>
                ...
                <div class="col-lg-4">
                    ...
                    <h2 class="display-6">Cercanía</h2>
                    <hr style="color: #FFB28C;">
                ...
                <div class="col-lg-4">
                    ...
                    <h2 class="display-6">Esfuerzo y superación</h2>
                    <hr style="color: #FFB28C;">
        ...
        <div class="card">
            <div class="content">
                ...
                <div class="img">
                    ...
                    <h4>Araceli</h4>
                    <h6>Creadora</h6>
                    <p>Emprendedora y vendedora de multiples marcas reconocidas</p>
                    <p>Trabajando desde 2010</p>
                </div>
            </div>
            <div class="links">
